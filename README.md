...
<body>
  ...
  <main>
    ...
    <section id="skills"><h2>Skills</h2>
       ...
       <article><ul><li>Scheduling & labor management</li></ul></article> 
       <article><ul><li>Inventory, ordering & vendor coordination</li></ul></article> 
       <article><ul><li>Beverage program development & menu design</li></ul></article> 
       <article><ul><li>Guest recovery & complaint resolution</li></ul></article> 
       <article><ul><li>POS & cash handling; basic sales/prospecting</li></ul></article>
    </section>
  </main>
